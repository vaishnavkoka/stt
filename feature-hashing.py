...
def deduplicate_files_simhash(file_paths, simhashes, folder_path, duplicates_folder, threshold=3):
...
def simhash_computation(file_paths, folder_path, duplicates_folder, threshold=45):
    simhashes = []
    ...
    unique_files = deduplicate_files_simhash(file_paths, simhashes, folder_path, duplicates_folder, threshold)
    return unique_files
